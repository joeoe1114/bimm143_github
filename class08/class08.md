...
Before analysis, I want to take out the expert dasgnoses column (a.k.a
the answer) from our data set.
...
analyzing large data sets. It works by finding new variables (PCs) that
capture the most variance from the original variable in your data set.
